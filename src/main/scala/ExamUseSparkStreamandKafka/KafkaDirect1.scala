...
object KafkaDirect1 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val ipRulesbroadcastRef: Broadcast[Array[(Long, Long, String)]] = sc.broadcast(ipRules)
        ...
        val lines: RDD[String] = kafkaRDD.map(_._2)
         ...
         //得到(provinceLong, 1)
          ...
          val provinceAndOne= lines.map(line => {
            ...
            val ipRules: Array[(Long, Long, String)] = ipRulesbroadcastRef.value
            val index: Int = UtillUseExamSparkKfka.binarySearch(ipRules,provinceLong)
